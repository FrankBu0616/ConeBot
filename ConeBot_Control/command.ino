void command(byte cmd, byte lift){
  ...
  switch (cmd) {
    ...
    case 97: //'a'front
      ...
      delay(60);
      robot.setJointSpeed(servoID2, 1324);
      delay(100);
    ...
    case 98://'b'back
      robot.setJointSpeed(servoID, 1328);
      delay(100);
      robot.setJointSpeed(servoID, 0);
      delay(50);
    ...
    case 101://'e'left
      robot.setJointSpeed(servoID, 1224);
      delay(10);
      robot.setJointSpeed(servoID2, 1224);
      //Serial.println ("e");
      break;

    case 102: //'f' fast front
      robot.setJointSpeed(servoID, 900);
      delay(10);
      robot.setJointSpeed(servoID2, 1900);
      //Serial.println ("a");
      break;  

    case 103://'g' fast back
      robot.setJointSpeed(servoID, 1924);
      delay(10);
      robot.setJointSpeed(servoID2, 800);
      //Serial.println ("b");
      break;
