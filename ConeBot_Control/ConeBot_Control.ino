...
// MAC addresses of the board(s) you are broadcasting
uint8_t broadcastAddress1[] = {0x94, 0xB9, 0x7E, 0xD2, 0xDF, 0x38};
//uint8_t broadcastAddress2[] = {0x94, 0xB9, 0x7E, 0xC0, 0xE6, 0xE8};
